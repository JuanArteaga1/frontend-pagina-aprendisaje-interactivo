              ...
              {pasosInfo.map((paso) => (
                <React.Fragment key={paso.id}>
                  ...
                  <div className="flex flex-col items-center relative z-10 px-6">
                    <span
                      className={`w-12 h-12 flex items-center justify-center rounded-full text-white font-bold transition-colors duration-300
            ${pasoActual === paso.id ? 'bg-blue-600 shadow-md' : 'bg-gray-400'}`}
                    >
                      {/* Aquí va el icono en lugar del número */}
