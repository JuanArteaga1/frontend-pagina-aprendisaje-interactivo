...
const Fisica = () => {
  ...
  const simulacionesFisica = useMemo(
    () =>
      Simulaciones.filter((sim) => sim.materia?.nombre === "Física").map(
        (sim) => ({
  ...
  const aplicacionesFisica = useMemo(
    () =>
      Proyectos.filter((app) => app.materia?.nombre === "Física").map((app) => ({
  ...
  // 🔹 Reutilizo este render de tarjeta
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-2xl text-gray-600 max-w-3xl mx-auto">
            ...
            de la física una experiencia fascinante.
          </p>
        </div>
        ...
        <section className="mb-20">
          ...
          {renderTarjetas(simulacionesFisica, "💡")}
        </section>
        ...
        <section className="mb-20">
          ...
          {renderTarjetas(aplicacionesFisica, "📱")}
        </section>
      </div>
    </div>
  );
